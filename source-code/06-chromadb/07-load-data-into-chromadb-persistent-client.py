...
if 'mylibrary-persistent-local-client' in collection_names:
    chroma_client.delete_collection(name='mylibrary-persistent-local-client')
    print("Existing collection 'mylibrary-persistent-local-client' deleted.")

# Create a new collection
collection = chroma_client.create_collection(name='mylibrary-persistent-local-client')
...
mylibrary_collection = chroma_client.get_collection(name='mylibrary-persistent-local-client')
