...
os.environ['CHROMA_DATABASE_NAME'] = 'mylibrary-cosine'
...
if 'mylibrary-cosine' in collection_names:
    chroma_client.delete_collection(name='mylibrary-cosine')
    print("Existing collection 'mylibrary-cosine' deleted.")

# Create a new collection
collection = chroma_client.create_collection(
    name='mylibrary-cosine',
    metadata = {
        "hnsw:space": "cosine",
        "hnsw:search_ef": 100
    }
...
print("Collection 'mylibrary-cosine' created and data loaded successfully.")
...
mylibrary_collection = chroma_client.get_collection(name='mylibrary-cosine')
